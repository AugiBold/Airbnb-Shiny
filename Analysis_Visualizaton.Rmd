...
```
I first select data fields pertaining to my question of interest from the main dataset and also extract the review-score data from the listings_detailed dataset and join it to the main dataset to capture the review scores. 
```{r}
listings %>% 
#listings_detailed %>% select('id', 'review_scores_rating')
